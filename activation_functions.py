...
def plot_predictions(dates_array, prediction_values, actual_values, frame, activation_function):
    """
    ...
    :param activation_function: Activation function used for the current Neural Network
...
def print_accuracy(accuracies, functions):
    """
    ...
    """
    for value, function in zip(accuracies, functions):
        print(function + " Function: " + str(round(value*100, 2)) + "%")
...
for activation in activation_functions:
    ...
    count = plot_predictions(dates, predictions, actual, count, activation)

print_accuracy(accuracy, activation_functions)
plt.show()
